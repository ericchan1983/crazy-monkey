...
public class ArgumentListBuilder implements Serializable, Cloneable {
	 ...
	 * space *?,;^&<>|"
	 * and if escapeVars is true, % followed by a letter. <br/>
	 ...
	 * this method. <br/>
	 * A " is prepended with another " character. Note: Windows has issues
	 * escaping some combinations of quotes and spaces. Quotes should be avoided. <br/>
	 * If escapeVars is true, a % followed by a letter has that letter wrapped
